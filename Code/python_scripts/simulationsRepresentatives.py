...
treatments = ["None","TMZ","ICI","OV","TMZ+ICI+OV","ICI+OV"]
Nsimul = len(treatments) #number of simulations per patient
TMZsimul = ["false","true","false","false","true","false"]
ICIsimul = ["false","false","true","false","true","true"]
OVsimul = ["false","false","false","true","true","true"]
...
patient = ["bottomRepCell","topRepCell"]
...
for nPatient in range(len(patient)):
    ...
    for i in range(Nsimul):
        ...
        for nR in range(Nreplicate):    
            ...
            newV0 = ((5/9740)*10000*10000)/(20*20*math.pi)
